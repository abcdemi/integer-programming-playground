...
# =============================================================================
# PART 1: SIMULATED GCN MODEL (Unchanged)
# =============================================================================
class SimulatedGCN:
...
# =============================================================================
# PART 2: THE BRANCHING STRATEGIES (Unchanged)
# =============================================================================
...
# =============================================================================
# PART 3: THE CORE SOLVER & **NEW** PROBLEM GENERATOR
# =============================================================================
def branch_and_bound_solver(c, A_ub, b_ub, branching_strategy, gcn_model=None):
    # This function remains the same, it's robust to the problem type
...
def generate_multi_constraint_ip(num_vars, num_cons, seed):
    """
    Generates a random 0-1 Integer Program with multiple constraints,
    which is necessary to create multiple fractional variables.
    """
    np.random.seed(seed)
    # Objective function
    ...
    density = 0.3 # About 30% of entries will be non-zero
    ...
    # Right-hand side b
    # Set b to be a fraction of the sum of coefficients to ensure feasibility
...
if __name__ == '__main__':
    ...
    print("\n\n" + "="*60)
    print(" " * 20 + "FINAL EXPERIMENT RESULTS")
    print("="*60)
    ...
    print("SUCCESS: The node counts are now different, showing that the strategies")
    print("are making unique decisions on these more complex problems.")
    print("As predicted, the 'Oracle' (strong branching) is the most efficient,")
    print("and the GCN simulation's performance falls between the two extremes.")